	...
	return (
		<PageLayout contentClassName={styles.TermsOfUseAndPrivacyPolicy}>
			...
			<ul>
				...
				<li>
					<p><strong>Website</strong> refers to SnapChallenge, accessible from <a href="https://www.challenge.snapsoft.hu" rel="external nofollow noopener" target="_blank">https://www.challenge.snapsoft.hu</a></p>
				</li>
				<li>
			...
			<ul>
				<li>By email: info@snapsoft.hu</li>
			</ul>
		</PageLayout>
	);
};
