...
The individual (contributing to a team or not) with the highest rank at the end will also be eligible to a special prize at the Snapsoft booth on 2021.10.05.
...
- Requirements (breaking these rules will result in **a ban**)
	...
	- You upload misleading code after correctly completing a submission (more about this in the Api Guide)
- Structure
